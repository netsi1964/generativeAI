const parts = [
  ...
  },
  {
    ...
    examples: [
      "Danish Farmer Using Futuristic Drone",
      "Elon Musk as Terminator",
      "Will Smith Celebrating Thanksgiving",
      "Futuristic Delhi Metro",
      "Robot Vendor Serving Thai food",
      "Astronaut Exploring Mars",
      "Medieval Knight in Battle",
      "Cyborg in a Dystopian Future",
      "Wizard Casting Spells",
      "Steampunk Inventor in Workshop",
  ...
  {
    name: "Dall-e 3",
    shortDescription: "Examples from Dall-e 3",
    detailedDescription: "Use them to get a specific style",
    examples: [
      "3D Wireframe",
      "Acrylic",
      "Analog film",
